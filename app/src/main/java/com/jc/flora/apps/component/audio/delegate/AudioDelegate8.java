...
import com.jc.flora.apps.component.audio.service.Audio8Service;
 ...
 */
public class AudioDelegate8 extends Binder {
    ...
    private static class AudioServiceConnection implements ServiceConnection{
        ...
        // 当前控制播放组件
        private AudioDelegate8 delegate;

        // 连接Service时回调，保存控制播放组件
        @Override
        public void onServiceConnected(ComponentName name, IBinder service) {
            if(builder != null && service instanceof AudioDelegate8){
                delegate = (AudioDelegate8)service;
                // 绑定连接对象是为了方便解绑
    ...
    public interface DelegateBuilder{
        void onBind(AudioDelegate8 delegate);
    }
