...
/**
 * Created by shijincheng on 2019/4/23.
 */

public class AudioListPlayerDelegate27 {
    ...
    private AudioDelegate27 mDelegate;
    // mp3列表
    ...
    public AudioListPlayerDelegate27(AppCompatActivity activity) {
        mActivity = activity;
    }
    ...
    private void initDelegate() {
        Intent intent = new Intent(mActivity, Audio27Service.class);
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            mDelegate = (AudioDelegate27) service;
    ...
    private void gotoAudioDetail(){
        mActivity.startActivity(new Intent(mActivity, AudioDetail27Activity.class));
    }
