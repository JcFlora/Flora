...
public class AudioNotifierDelegate25 {
    ...
    public AudioNotifierDelegate25(Service service, AudioDelegate25 audioDelegate) {
        mService = service;
    ...
    private Notification buildNotification(MP3 mp3, boolean isPlaying) {
        ...
        Intent intent = new Intent(mService, AudioDetail25Activity.class);
