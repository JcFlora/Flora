 ...
 */
public class PrayBottomSheetDialogDelegate {
    ...
    private PrayBottomSheetDialogDelegate.ViewHolder mHolder;
    private String mRole = "";

    private OnRoleCheckedListener mOnRoleCheckedListener;

    public PrayBottomSheetDialogDelegate(AppCompatActivity activity) {
        mActivity = activity;
    ...
    private void onCreateViewHolder(){
        mHolder = new PrayBottomSheetDialogDelegate.ViewHolder();
