...
public class AudioListPlayerDelegate25 {
    ...
    public AudioListPlayerDelegate25(AppCompatActivity activity) {
        mActivity = activity;
    }
    ...
    private void gotoAudioDetail(){
        mActivity.startActivity(new Intent(mActivity, AudioDetail25Activity.class));
    }
