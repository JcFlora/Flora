...
class AudioActivity : AppCompatActivity() {
    ...
    private val project2: Project
        get() {
            val project = Project()
            project.projectName = "后台Service播放本地MP3"
    ...
    private val project5: Project
        get() {
            val project = Project()
            project.projectName = "支持多个MP3切换播放"
    ...
    private val project6: Project
        get() {
            val project = Project()
            project.projectName = "支持上一首／下一首功能"
    ...
    private val project9: Project
        get() {
            val project = Project()
            project.projectName = "实现三种播放模式切换"
            project.targetActivity = NotFoundActivity::class.java
            return project
        }
    ...
    private val project11: Project
        get() {
            val project = Project()
            project.projectName = "实现通知栏显示和交互"
            project.targetActivity = NotFoundActivity::class.java
            return project
        }
    ...
    private val project15: Project
        get() {
            val project = Project()
            project.projectName = "使用ExoPlayer播放本地MP3"
            project.targetActivity = NotFoundActivity::class.java
            return project
        }
