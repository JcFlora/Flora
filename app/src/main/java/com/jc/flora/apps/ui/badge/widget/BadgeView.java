package com.jc.flora.apps.ui.badge.widget;
...
/**
 * Created by Samurai on 2016/7/6.
 */
public class BadgeView extends TextView {
    ...
    private void applyTo(View target) {
        ...
        if (target instanceof TabWidget) {
            ...
            this.target = target;
            ((ViewGroup) target).setClipChildren(false);
    ...
    public void setBadgeNumberText(int numberText) {
        String s = numberText > 99 ? "99+" : numberText + "";
        setBadgeText(s);
        setVisibility(numberText > 0 ? View.VISIBLE : View.GONE);
    }
...
//        if(text.length() > 1){
//            setTextSize(8);
//            int paddingPixels = dipToPixels(3);
//            int paddingPixelsV = dipToPixels(2);
//            setPadding(paddingPixels, paddingPixelsV, paddingPixels, paddingPixelsV);
//        }
        show();
    }
