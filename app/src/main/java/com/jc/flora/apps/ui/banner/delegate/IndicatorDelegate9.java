 ...
 */
public class IndicatorDelegate9 extends Fragment {
    ...
    private void initIndicatorsLayout(){
        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mLayoutBannerIndicators.getLayoutParams();
