 ...
 */
public class WriteSdPermitDelegate extends Fragment {
    ...
    private static final String REQUEST_PERMISSION = Manifest.permission.WRITE_EXTERNAL_STORAGE;
    ...
    public void requestPermission() {
        if (ContextCompat.checkSelfPermission(getActivity(), REQUEST_PERMISSION)
            ...
            //申请Sd卡权限
            requestPermissions(new String[]{REQUEST_PERMISSION}, REQUEST_CODE);
        }
    }
