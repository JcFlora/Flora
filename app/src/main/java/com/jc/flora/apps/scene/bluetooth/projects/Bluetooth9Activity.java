...
import com.jc.flora.apps.scene.bluetooth.delegate.BluetoothDelegate9;
 ...
 */
public class Bluetooth9Activity extends AppCompatActivity {

    private BluetoothDelegate9 mBluetoothDelegate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("设置可检测性");
        setContentView(R.layout.activity_bluetooth9);
        initViews();
        initBluetooth();
    }
    ...
    private void initBluetooth() {
        mBluetoothDelegate = new BluetoothDelegate9();
