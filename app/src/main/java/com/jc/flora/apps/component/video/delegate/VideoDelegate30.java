...
import com.jc.flora.apps.component.video.player.OnVideoSizeChangedListener;
...
public class VideoDelegate30 extends BaseVideoDelegate {
    ...
    private OnVideoSizeChangedListener mOnVideoSizeChangedListener = new OnVideoSizeChangedListener() {
        ...
        public void onVideoSizeChanged(int width, int height) {
            // 添加返回视频尺寸时的回调
            mPlayer.callbackWhenVideoSizeChanged(width, height);
        }
    };
