 ...
 */
public class GetArticleListApi extends BaseApi<NetResponse> {
    ...
    public GetArticleListApi(AppCompatActivity activity, Response.Listener<NetResponse> l) {
        super(activity, l);
    }

    public GetArticleListApi(AppCompatActivity activity, Response.Listener<NetResponse> l, Response.ErrorListener el) {
        super(activity, l, el);
    }
