...
public class AudioNotifierDelegate28 {
    ...
    public AudioNotifierDelegate28(Service service, AudioDelegate28 audioDelegate) {
        mService = service;
    ...
    private Notification buildNotification(MP3 mp3, boolean isPlaying) {
        ...
        Intent intent = new Intent(mService, AudioDetail28Activity.class);
