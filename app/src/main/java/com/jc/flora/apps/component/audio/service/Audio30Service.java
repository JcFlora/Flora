...
public class Audio30Service extends Service {
    ...
    public static void start(Context context){
        context.startService(new Intent(context, Audio30Service.class));
    }
    ...
    public static void stop(Context context){
        context.stopService(new Intent(context, Audio30Service.class));
    }
