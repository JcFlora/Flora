 ...
 */
public class Captain18Activity extends AppCompatActivity {
    ...
    private LoginActionDelegate.LoginActionCallback mLoginActionCallback = new LoginActionDelegate.LoginActionCallback() {
        ...
        public void onLoginSuccess() {
            ToastDelegate.show(Captain18Activity.this, "登录成功");
            mFragmentDelegate.onTabIndicatorCheckedChanged(LOGIN_INDEX);
        }
        @Override
        public void onLoginCancel() {
            ToastDelegate.show(Captain18Activity.this, "取消登录");
    ...
    public void onBackPressed() {
        if(!mIndicatorDelegate.back2Tab0()){
            super.onBackPressed();
        }
    }
}