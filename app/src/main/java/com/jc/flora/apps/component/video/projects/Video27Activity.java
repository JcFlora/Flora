 ...
 */
public class Video27Activity extends AppCompatActivity {
    ...
    private VideoFullTouchLockDelegate mFullLockDelegate;
    ...
    private void findViews(){
        ...
        mLayoutVideoRender = LayoutInflater.from(this).inflate(R.layout.layout_video_render27, mRvVideo, false);
    ...
    private void initFullScreenDelegate(){
        ...
        mFullScreenDelegate.setOnOrientationChangedListener(new VideoFullScreenDelegate17.OnOrientationChangedListener() {
            ...
            public void onLandscape() {
                ...
                mFullLockDelegate.reset();
                mFullLockDelegate.setLockEnable(true);
            }
            @Override
            public void onPortrait() {
                ...
                mGestureCover.setGestureEnable(false);
                mFullLockDelegate.reset();
                mFullLockDelegate.setLockEnable(false);
            }
        });
    ...
    private void initFullLockDelegate(){
        ...
        mFullLockDelegate = new VideoFullTouchLockDelegate();
        mFullLockDelegate.setBtnLock(btnLock);
        mFullLockDelegate.setLockedWidgets(layoutControllerTop, layoutControllerBottom);
        mFullLockDelegate.setGestureCover(mGestureCover);
        mFullLockDelegate.init();
    }
