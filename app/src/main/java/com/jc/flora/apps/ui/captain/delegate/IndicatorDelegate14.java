 ...
 */
public class IndicatorDelegate14 implements ViewPager.OnPageChangeListener{
    ...
    public void rollback(){
        ...
        if (mPreviousIndex >= 0 && mPreviousIndex < mCount) {
            mTabs[mPreviousIndex].onChecked(mPreviousIndex);
            updateIndex(mPreviousIndex);
        }
    }
        ...
        public View createTab(final int position) {
            ...
            mBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    clearAllChecked();
                    IndicatorDelegate14.this.onChecked(position);
                }
            });
            return mBtn;
        }
