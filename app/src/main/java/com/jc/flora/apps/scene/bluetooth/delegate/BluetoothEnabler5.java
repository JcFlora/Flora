 ...
 */
public class BluetoothEnabler5 {
    ...
    public void setOnBtStateChangeListener(OnBtStateChangeListener onBtStateChangeListener) {
        mOnBtStateChangeListener = onBtStateChangeListener;
    }
    ...
    private BtStateChangeReceiver mBtStateChangeReceiver = new BtStateChangeReceiver() {
        ...
        protected void onStateOff() {
            ...
            if(mOnBtStateChangeListener != null){
                mOnBtStateChangeListener.onStateOff();
            }
        }
        @Override
        protected void onStateTurningOn() {
            ...
            mTvBtTip.setVisibility(View.VISIBLE);
            if(mOnBtStateChangeListener != null){
                mOnBtStateChangeListener.onStateTurningOn();
            }
        }
        @Override
        protected void onStateOn() {
            ...
            if(mOnBtStateChangeListener != null){
                mOnBtStateChangeListener.onStateOn();
            }
        }
        @Override
        protected void onStateTurningOff() {
            ...
            mTvBtTip.setVisibility(View.VISIBLE);
            if(mOnBtStateChangeListener != null){
                mOnBtStateChangeListener.onStateTurningOff();
            }
        }
        @Override
        protected void onStateError() {
            ...
            mTvBtTip.setVisibility(View.GONE);
            if(mOnBtStateChangeListener != null){
                mOnBtStateChangeListener.onStateError();
            }
        }
    };
