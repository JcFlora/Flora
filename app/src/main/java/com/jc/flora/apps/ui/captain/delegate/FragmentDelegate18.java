 ...
 */
public class FragmentDelegate18 implements IndicatorDelegate18.OnTabIndicatorClickListener{

    private int mContainerViewId;
    private CaptainFragment[] mFragmentList;
    ...
    public void setFragmentList(CaptainFragment[] fragmentList) {
    ...
    public void onTabIndicatorReClick(int position) {
        mFragmentList[position].onReload(position);
    }
