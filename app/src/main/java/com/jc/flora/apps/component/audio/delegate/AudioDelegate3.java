...
import com.jc.flora.apps.component.audio.projects.Audio3Service;

/**
 * Created by Samurai on 2017/10/5.
 */
public class AudioDelegate3 extends Binder {
    ...
    public interface DelegateBuilder{
        void onBind(AudioDelegate3 delegate);
    }
