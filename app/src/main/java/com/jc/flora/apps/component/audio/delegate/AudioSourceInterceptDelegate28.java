...
public class AudioSourceInterceptDelegate28 {

    /** 获取真实URI的回调标记 */
    private static final int FLAG_GET_URI_BY_ID = 0x1357;
    /** 触发支付的回调标记 */
    private static final int FLAG_GO_TO_PAY = 0x2468;
    ...
    public AudioSourceInterceptDelegate28(AudioDelegate28 audioDelegate) {
    ...
    private AudioStatusListener mAudioStatusListener = new AudioStatusListener(){
        ...
        public boolean interceptSelect(final ArrayList<MP3> mp3List, final int index) {
            ...
            if(intercept && !mIsBusying){
                ...
                mAudioDelegate.notifySelectIntercepted(index, FLAG_GET_URI_BY_ID);
            }
            return intercept;
        }
    };
