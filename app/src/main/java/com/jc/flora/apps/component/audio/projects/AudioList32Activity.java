...
import com.jc.flora.apps.component.audio.service.Audio32Service;
import com.jc.flora.apps.ui.progress.widget.RoundProgressBar;

/**
 * Created by Samurai on 2019/4/28.
 */
public class AudioList32Activity extends AppCompatActivity {
    ...
    private void initDelegate(){
        mDelegate = new AudioListPlayerDelegate30(this, Audio32Service.class, AudioDetail32Activity.class);
