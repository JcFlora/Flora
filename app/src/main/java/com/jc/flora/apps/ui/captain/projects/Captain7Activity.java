...
import com.jc.flora.apps.ui.captain.delegate.FragmentDelegate7;
import com.jc.flora.apps.ui.captain.delegate.IndicatorDelegate7;

/**
 * Created by shijincheng on 2017/5/2.
 */
public class Captain7Activity extends AppCompatActivity {
    ...
    private FragmentDelegate7 mFragmentDelegate;
    private IndicatorDelegate7 mIndicatorDelegate;
    ...
    private void initFragments(){
        ...
        mFragmentDelegate = new FragmentDelegate7();
    ...
    private void initIndicators() {
        mIndicatorDelegate = new IndicatorDelegate7();
