...
public class AudioNotifierDelegate27 {
    ...
    public AudioNotifierDelegate27(Service service, AudioDelegate27 audioDelegate) {
        mService = service;
    ...
    private Notification buildNotification(MP3 mp3, boolean isPlaying) {
        ...
        Intent intent = new Intent(mService, AudioDetail27Activity.class);
