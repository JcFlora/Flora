...
import com.jc.flora.apps.component.audio.service.Audio20Service;
...
public class AudioPlayerDelegate20 {
    ...
    public AudioPlayerDelegate20(AppCompatActivity activity) {
        mActivity = activity;
    }
    ...
    private void initDelegate() {
        Intent intent = new Intent(mActivity, Audio20Service.class);
