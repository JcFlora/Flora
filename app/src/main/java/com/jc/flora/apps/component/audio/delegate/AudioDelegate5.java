...
import com.jc.flora.apps.component.audio.projects.Audio5Service;
 ...
 */
public class AudioDelegate5 extends Binder {
    ...
    private static class AudioServiceConnection implements ServiceConnection{
        ...
        // 当前控制播放组件
        private AudioDelegate5 delegate;

        // 连接Service时回调，保存控制播放组件
        @Override
        public void onServiceConnected(ComponentName name, IBinder service) {
            if(builder != null && service instanceof AudioDelegate5){
                delegate = (AudioDelegate5)service;
                // 绑定连接对象是为了方便解绑
    ...
    public interface DelegateBuilder{
        void onBind(AudioDelegate5 delegate);
    }
