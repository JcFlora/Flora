...
public class AudioNotifierDelegate24 {
    ...
    public AudioNotifierDelegate24(Service service, AudioDelegate24 audioDelegate) {
        mService = service;
    ...
    private Notification buildNotification(MP3 mp3, boolean isPlaying) {
        ...
        Intent intent = new Intent(mService, AudioDetail24Activity.class);
