 ...
 */
public class IndicatorDelegate21 {
    ...
    private BannerView21.Position mIndicatorPosition;
    ...
    public void setIndicatorPosition(BannerView21.Position indicatorPosition) {
