 ...
 */
public class SwipeRefreshLayout3 extends ViewGroup {
    // Maps to ProgressBar.Large style
    public static final int LARGE = MaterialProgressDrawable3.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = MaterialProgressDrawable3.DEFAULT;

    private static final String LOG_TAG = SwipeRefreshLayout3.class.getSimpleName();
    ...
    private CircleImageView3 mCircleView;
    ...
    private MaterialProgressDrawable3 mProgress;
    ...
    public void setSize(int size) {
        if (size != MaterialProgressDrawable3.LARGE && size != MaterialProgressDrawable3.DEFAULT) {
            return;
        }
        final DisplayMetrics metrics = getResources().getDisplayMetrics();
        if (size == MaterialProgressDrawable3.LARGE) {
     ...
     * @param context
     */
    public SwipeRefreshLayout3(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SwipeRefreshLayout3(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void createProgressView() {
        mCircleView = new CircleImageView3(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
        mProgress = new MaterialProgressDrawable3(getContext(), this);
