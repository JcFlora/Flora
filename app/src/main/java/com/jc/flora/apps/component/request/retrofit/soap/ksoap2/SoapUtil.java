...
import com.jc.flora.apps.component.request.retrofit.soap.io.KXmlParser;
import com.jc.flora.apps.component.request.retrofit.soap.io.KXmlSerializer;
...
public class SoapUtil {
    static final String CONTENT_TYPE_XML_CHARSET_UTF_8 = "text/xml;charset=utf-8";
    static final String CONTENT_TYPE_SOAP_XML_CHARSET_UTF_8 = "application/soap+xml;charset=utf-8";
    static final String USER_AGENT = "ksoap2-android/2.6.0+";
     ...
     */
    static byte[] createRequestData(SoapEnvelope envelope, String encoding)
            throws IOException {
