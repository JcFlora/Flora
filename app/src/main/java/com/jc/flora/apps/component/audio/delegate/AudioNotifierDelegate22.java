...
public class AudioNotifierDelegate22 {
    ...
    public AudioNotifierDelegate22(Service service, AudioDelegate22 audioDelegate) {
        mService = service;
    ...
    private Notification buildNotification(MP3 mp3, boolean isPlaying) {
        ...
        Intent intent = new Intent(mService, AudioDetail22Activity.class);
