...
import com.jc.flora.apps.component.audio.delegate.AudioPlayerDelegate14;

/**
 * Created by Samurai on 2017/10/15.
 */
public class Audio14Activity extends AppCompatActivity {

    private AudioPlayerDelegate14 mDelegate;
    // 当前mp3音频封面图
    ...
    private void initDelegate(){
        mDelegate = new AudioPlayerDelegate14(this);
